const data = {
  ...
  "judson": ["sonny","jud"],
  "judy": ["judith"],
  "julia": ["julie","jill","jules"],
  "julian": ["jule","jules"],
  "julias": ["jule","jules"],
  "julie": ["julia","jule","jules"],
  "june": ["junius"],
  ...
  "rick": ["ricky"],
  "ricky": ["dick","rich"],
  "robert": ["hob","hobkin","dob","rob","bobby","dobbin","bob","bill","billy","robby","rupert"],
  "roberta": ["robbie","bert","bobbie","birdie","bertie","roby","birtie"],
  "roberto": ["rob"],
  "roderick": ["rod","erick","rickie","roddy"],
  "rodger": ["roge","bobby","hodge","rod","roger"],
  "rodney": ["rod"],
  "roger": ["roge","bobby","hodge","rod","rodger"],
